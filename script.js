...
function showView(view) {
  ...
  // view-maps siempre visible como base (excepto cuando se muestra la tabla)
  document.getElementById('view-maps').classList.toggle('hidden', view === 'table');
  document.getElementById('view-table').classList.toggle('hidden', view !== 'table');
  // Panel convergencia flota sobre los mapas
  const convPanel = document.getElementById('convergencia-panel');
  if (convPanel) convPanel.classList.toggle('hidden', view !== 'convergencia');
