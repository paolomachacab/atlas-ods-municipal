...
const ALL_THRESHOLDS = {
  ...
  '08_09_02_01_pot_ARLAT': { meta:{max:2000,min:15}, proximo:{max:15,min:10}, retos:{max:10,min:5}, grandes:{max:5,min:0} },
  '08_09_02_01_pot_INE':   { meta:{max:2000,min:15}, proximo:{max:15,min:10}, retos:{max:10,min:5}, grandes:{max:5,min:0} },
