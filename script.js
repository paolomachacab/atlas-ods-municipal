...
const ALL_THRESHOLDS = {
  '01_02_02_01_mpi': { meta:{max:0,min:0.07}, proximo:{max:0.07,min:0.13}, retos:{max:0.13,min:0.23}, grandes:{max:0.23,min:1} },
  ...
  '03_02_01_02_tmi': { meta:{max:0,min:12}, proximo:{max:12,min:16}, retos:{max:16,min:20}, grandes:{max:20,min:400} },
  '03_02_01_03_tmn': { meta:{max:0,min:25}, proximo:{max:25,min:37.5}, retos:{max:37.5,min:50}, grandes:{max:50,min:300} },
  '03_03_01_04_vih': { meta:{max:0,min:15}, proximo:{max:15,min:78}, retos:{max:78,min:155}, grandes:{max:155,min:20000} },
  '03_03_02_05_tub': { meta:{max:0,min:10}, proximo:{max:10,min:42.5}, retos:{max:42.5,min:75}, grandes:{max:75,min:433.4} },
  '03_03_03_06_vec': { meta:{max:0,min:0}, proximo:{max:0.000001,min:0.1}, retos:{max:0.1,min:0.3}, grandes:{max:0.3,min:1} },
  ...
  '04_02_02_03_tam': { meta:{max:100,min:90}, proximo:{max:90,min:80}, retos:{max:80,min:70}, grandes:{max:70,min:0} },
  ...
  '05_01_01_03_pge': { meta:{max:2,min:1}, proximo:{max:1,min:0.75}, retos:{max:0.75,min:0.5}, grandes:{max:0.5,min:0} },
  '05_01_01_04_pgp': { meta:{max:3,min:1}, proximo:{max:1,min:0.75}, retos:{max:0.75,min:0.5}, grandes:{max:0.5,min:0} },
  '05_04_01_05_phc': { meta:{max:3,min:1}, proximo:{max:1,min:0.75}, retos:{max:0.75,min:0.5}, grandes:{max:0.5,min:0} },
  ...
  '06_03_01_03_tar': { meta:{max:500,min:50}, proximo:{max:50,min:30}, retos:{max:30,min:15}, grandes:{max:15,min:0} },
  '07_01_01_01_cep': { meta:{max:1700,min:800}, proximo:{max:800,min:200}, retos:{max:200,min:50}, grandes:{max:50,min:0} },
  '07_01_01_02_cae': { meta:{max:100,min:98}, proximo:{max:98,min:89}, retos:{max:89,min:80}, grandes:{max:80,min:0} },
  '07_01_01_03_mcc': { meta:{max:0,min:4.5}, proximo:{max:4.5,min:10.2}, retos:{max:10.2,min:24.9}, grandes:{max:24.9,min:100} },
  ...
  '08_09_02_05_pot': { meta:{max:13,min:10}, proximo:{max:10,min:5}, retos:{max:5,min:2.5}, grandes:{max:2.5,min:0} },
  '08_09_02_06_pbt': { meta:{max:100,min:10}, proximo:{max:10,min:5}, retos:{max:5,min:2.5}, grandes:{max:2.5,min:0} },
  '08_10_02_07_dsb': { meta:{max:225,min:18}, proximo:{max:18,min:9}, retos:{max:9,min:5}, grandes:{max:5,min:0} },
  '09_01_01_01_vpc': { meta:{max:6,min:2}, proximo:{max:2,min:1}, retos:{max:1,min:0}, grandes:{max:0,min:0} },
  ...
  '10_02_01_01_esp': { meta:{max:0,min:5}, proximo:{max:5,min:15}, retos:{max:15,min:30}, grandes:{max:30,min:100} },
  ...
  '10_02_01_05_gip': { meta:{max:0,min:0.05}, proximo:{max:0.05,min:0.1}, retos:{max:0.1,min:0.15}, grandes:{max:0.15,min:1} },
  '10_04_02_06_gin': { meta:{max:0,min:0.31}, proximo:{max:0.31,min:0.39}, retos:{max:0.39,min:0.47}, grandes:{max:0.47,min:1} },
  ...
  '11_02_01_04_atc': { meta:{max:5400,min:93}, proximo:{max:93,min:49}, retos:{max:49,min:5}, grandes:{max:5,min:0} },
  '11_06_01_05_ipr': { meta:{max:999,min:200}, proximo:{max:200,min:100}, retos:{max:100,min:50}, grandes:{max:50,min:0} },
  '11_06_01_06_srr': { meta:{max:100,min:90}, proximo:{max:90,min:50}, retos:{max:50,min:10}, grandes:{max:10,min:0} },
  '11_06_02_07_ica': { meta:{max:0,min:10}, proximo:{max:10,min:15}, retos:{max:15,min:25}, grandes:{max:25,min:32} },
  '13_01_01_01_fec': { meta:{max:0,min:5}, proximo:{max:5,min:15}, retos:{max:15,min:30}, grandes:{max:30,min:500} },
  '13_01_03_02_icc': { meta:{max:0,min:0.94}, proximo:{max:0.94,min:1.55}, retos:{max:1.55,min:2.15}, grandes:{max:2.15,min:3} },
  '13_02_02_03_epb': { meta:{max:-20,min:2}, proximo:{max:2,min:3}, retos:{max:3,min:4}, grandes:{max:4,min:450} },
  '13_02_02_04_ect': { meta:{max:0,min:0}, proximo:{max:0.0000001,min:0.2}, retos:{max:0.2,min:0.7}, grandes:{max:0.7,min:99} },
  '13_02_02_05_eci': { meta:{max:0,min:2}, proximo:{max:2,min:3}, retos:{max:3,min:4}, grandes:{max:4,min:1300} },
  '15_01_02_01_sap': { meta:{max:100,min:25}, proximo:{max:25,min:15}, retos:{max:15,min:5}, grandes:{max:5,min:0} },
  '15_02_01_02_tpb': { meta:{max:0,min:0.05}, proximo:{max:0.05,min:0.5}, retos:{max:0.5,min:2}, grandes:{max:2,min:100} },
  '15_05_02_03_pbd': { meta:{max:0,min:0.06}, proximo:{max:0.06,min:0.17}, retos:{max:0.17,min:0.3}, grandes:{max:0.3,min:5} },
  '15_05_02_04_pbi': { meta:{max:0,min:0.15}, proximo:{max:0.15,min:0.8}, retos:{max:0.8,min:1.4}, grandes:{max:1.4,min:62} },
  '16_01_01_01_thp': { meta:{max:0,min:1.5}, proximo:{max:1.5,min:2.75}, retos:{max:2.75,min:4}, grandes:{max:4,min:60} },
...
const PERIOD_LABELS = {
  ...
  '07_01_01_03_mcc': { v1: 'Valor 2016', v2: 'Valor 2023' },
...
/* ══════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════ */
let idsCurrentPeriod = 'v2';
let idsCurrentSort   = 'ranking';
let idsSearchText    = '';
let idsMapLayer      = null;

function renderIDSView() {
  const container = document.getElementById('ids-table-body');
  if (!container) return;
  if (typeof IDS_DATA === 'undefined') {
    container.innerHTML = '<tr><td colspan="8" style="text-align:center;padding:32px;color:var(--text-muted)">Cargando datos IDS…</td></tr>';
    return;
  }
  document.getElementById('ids-btn-v1')?.classList.toggle('active', idsCurrentPeriod === 'v1');
  document.getElementById('ids-btn-v2')?.classList.toggle('active', idsCurrentPeriod === 'v2');

  let entries = Object.entries(IDS_DATA).map(([id, d]) => ({
    id, ...d,
    ids:     idsCurrentPeriod === 'v1' ? d.ids_v1 : d.ids_v2,
    ranking: idsCurrentPeriod === 'v1' ? d.ranking_v1 : d.ranking_v2,
  }));

  if (idsSearchText) {
    const q = idsSearchText.toLowerCase();
    entries = entries.filter(e => e.municipio.toLowerCase().includes(q));
  }

  if (idsCurrentSort === 'ranking')   entries.sort((a,b) => (a.ranking||999) - (b.ranking||999));
  else if (idsCurrentSort === 'ids_desc') entries.sort((a,b) => (b.ids||0) - (a.ids||0));
  else if (idsCurrentSort === 'cambio')   entries.sort((a,b) => (b.cambio_ids||0) - (a.cambio_ids||0));
  else if (idsCurrentSort === 'municipio') entries.sort((a,b) => a.municipio.localeCompare(b.municipio));

  container.innerHTML = entries.map(e => {
    const ids    = e.ids !== null && e.ids !== undefined ? e.ids.toFixed(1) : '—';
    const ids_v1 = e.ids_v1 !== null ? e.ids_v1.toFixed(1) : '—';
    const ids_v2 = e.ids_v2 !== null ? e.ids_v2.toFixed(1) : '—';
    const cambio = e.cambio_ids !== null ? (e.cambio_ids > 0 ? '+' : '') + e.cambio_ids.toFixed(1) : '—';
    const cambioClass = e.cambio_ids > 0 ? 'positive' : e.cambio_ids < 0 ? 'negative' : 'neutral';
    const pct = Math.min(100, Math.max(0, e.ids || 0));
    const barColor = pct >= 70 ? '#3cb35a' : pct >= 50 ? '#f0c419' : pct >= 30 ? '#f48620' : '#e63946';
    return '<tr>' +
      '<td style="font-weight:700;color:var(--accent)">' + (e.ranking || '—') + '</td>' +
      '<td style="font-weight:600">' + e.municipio + '</td>' +
      '<td>' + getDepartamento(e.id) + '</td>' +
      '<td>' + e.poblacion.toLocaleString() + '</td>' +
      '<td><div style="display:flex;align-items:center;gap:8px">' +
        ...
        '</div>' +
        '<span style="font-weight:700;min-width:36px;text-align:right">' + ids + '</span>' +
      '</div></td>' +
      '<td>' + ids_v1 + '</td>' +
      '<td>' + ids_v2 + '</td>' +
      '<td class="tooltip-change ' + cambioClass + '" style="font-weight:600">' + cambio + '</td>' +
      '</tr>';
  }).join('');

  const countEl = document.getElementById('ids-count');
  if (countEl) countEl.textContent = entries.length + ' municipios';

  // Render IDS map
  renderIDSMap();
}

function renderIDSMap() {
  if (!state.geoMun) return;
  const mapEl = document.getElementById('ids-map');
  if (!mapEl) return;

  // Init map if needed
  if (!window.idsMapInstance) {
    const bounds = L.latLngBounds(BOLIVIA_BOUNDS[0], BOLIVIA_BOUNDS[1]);
    window.idsMapInstance = L.map('ids-map', {
      zoomControl: true, attributionControl: false, maxBounds: bounds.pad(0.3)
    }).fitBounds(bounds);
    L.tileLayer('https://{s}.basemaps.cartocdn.com/light_nolabels/{z}/{x}/{y}{r}.png',
      { attribution: '©OSM ©Carto', subdomains: 'abcd', maxZoom: 19 }
    ).addTo(window.idsMapInstance);
  }

  if (idsMapLayer) window.idsMapInstance.removeLayer(idsMapLayer);

  function getIDSColor(ids) {
    if (ids === null || ids === undefined) return '#e5e7eb';
    if (ids >= 70) return '#1e3a5f';
    if (ids >= 60) return '#2563a8';
    if (ids >= 50) return '#5b9bd5';
    if (ids >= 40) return '#93c4e6';
    return '#c7e2f0';
  }

  idsMapLayer = L.geoJSON(state.geoMun, {
    style: feature => {
      const id = getFeatureId(feature);
      const d  = (typeof IDS_DATA !== 'undefined') ?
        (IDS_DATA[id] || IDS_DATA[String(parseInt(id))]) : null;
      const ids = d ? (idsCurrentPeriod === 'v1' ? d.ids_v1 : d.ids_v2) : null;
      return {
        fillColor:   getIDSColor(ids),
        fillOpacity: 0.85,
        color:       '#fff',
        weight:      0.5,
      };
    ...
    onEachFeature: (feature, layer) => {
      layer.on({
        mouseover: e => {
          e.target.setStyle({ weight: 2, color: '#1d4ed8' });
          const id = getFeatureId(feature);
          const name = getFeatureName(feature);
          const d = (typeof IDS_DATA !== 'undefined') ?
            (IDS_DATA[id] || IDS_DATA[String(parseInt(id))]) : null;
          const ids_v1 = d ? d.ids_v1 : null;
          const ids_v2 = d ? d.ids_v2 : null;
          const rank   = d ? (idsCurrentPeriod === 'v1' ? d.ranking_v1 : d.ranking_v2) : null;
          dom.tooltip.innerHTML =
            '<div class="tooltip-name">' + name + '</div>' +
            '<div class="tooltip-row"><span class="tooltip-key">IDS ~2012</span><span class="tooltip-val">' + (ids_v1 !== null ? ids_v1.toFixed(1) : '—') + '</span></div>' +
            '<div class="tooltip-row"><span class="tooltip-key">IDS ~2024</span><span class="tooltip-val">' + (ids_v2 !== null ? ids_v2.toFixed(1) : '—') + '</span></div>' +
            '<div class="tooltip-row"><span class="tooltip-key">Ranking</span><span class="tooltip-val">' + (rank || '—') + '</span></div>';
  ...
  try {
    const b = idsMapLayer.getBounds();
    if (b.isValid()) window.idsMapInstance.fitBounds(b, { padding:[20,20], animate:false });
  } catch(e) {}
}
