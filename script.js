...
function renderConvergence(data) {
  ...
  if (r < -0.3) {
    ...
    detail = 'Los municipios más rezagados avanzan proporcionalmente más.';
  } else if (r > 0.3) {
    icon = '↗↘'; label = 'Divergencia'; colorClass = 'conv-diverge';
    detail = 'Los municipios en mejor situación concentran las mayores mejoras.';
  } else {
    icon = '→'; label = 'Sin patrón claro'; colorClass = 'conv-neutral';
    detail = 'No hay patrón claro entre posición inicial y ritmo de mejora.';
  }
