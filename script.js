...
const ALL_THRESHOLDS = {
  ...
  '08_09_02_01_pot':       { meta:{max:2000,min:15}, proximo:{max:15,min:10}, retos:{max:10,min:10}, grandes:{max:5,min:0} },
  '08_09_02_01_pot_ARLAT': { meta:{max:2000,min:15}, proximo:{max:15,min:10}, retos:{max:10,min:10}, grandes:{max:5,min:0} },
  '08_09_02_01_pot_INE':   { meta:{max:2000,min:15}, proximo:{max:15,min:10}, retos:{max:10,min:10}, grandes:{max:5,min:0} },
  ...
  '16_07_02_03_tcs': { meta:{max:0,min:20}, proximo:{max:20,min:50}, retos:{max:50,min:80}, grandes:{max:80,min:100} },
