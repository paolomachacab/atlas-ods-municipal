      ...
      <div class="conv-formula">
        <div class="conv-formula-row">
          ...
          <div class="conv-formula-frac">
            <div class="conv-formula-num">Σ (x<sub>i</sub> − x̄)(y<sub>i</sub> − ȳ)</div>
            <div class="conv-formula-den">√[ Σ(x<sub>i</sub>−x̄)² · Σ(y<sub>i</sub>−ȳ)² ]</div>
          </div>
        </div>
        <div class="conv-formula-legend">
          <span><b>x</b> = valor inicial del indicador</span>
          <span><b>y</b> = cambio favorable al período final</span>
        </div>
      </div>
