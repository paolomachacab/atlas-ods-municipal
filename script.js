...
const ALL_THRESHOLDS = {
  ...
  '01_04_01_04_psv': { meta:{max:0,min:70}, proximo:{max:70,min:141}, retos:{max:141,min:282}, grandes:{max:282,min:1185} },
  '02_02_02_01_smu': { meta:{max:0,min:15.6}, proximo:{max:15.6,min:22.05}, retos:{max:22.05,min:28.5}, grandes:{max:28.5,min:100} },
  ...
  '02_02_03_04_pam': { meta:{max:0,min:30.3}, proximo:{max:30.3,min:41.9}, retos:{max:41.9,min:53.4}, grandes:{max:53.4,min:100} },
  ...
  '03_12_01_14_ppv': { meta:{max:100,min:83.3506985188644}, proximo:{max:83.3506985188644,min:61.07378602593669}, retos:{max:61.07378602593669,min:38.79687353300898}, grandes:{max:38.79687353300898,min:0} },
  ...
  '05_07_02_06_ttm': { meta:{max:100,min:50}, proximo:{max:50,min:39.3}, retos:{max:39.3,min:17.6}, grandes:{max:17.6,min:0} },
  ...
  '09_08_01_01_ci':  { meta:{max:100,min:71.85}, proximo:{max:71.85,min:58.13}, retos:{max:58.13,min:44.41833632466562}, grandes:{max:44.41833632466562,min:0} },
  ...
  // Hacinamiento — umbral A (más estricto, según Excel fila 1)
  '11_01_01_01_thm':     { meta:{max:0,min:31}, proximo:{max:31,min:42.4}, retos:{max:42.4,min:54}, grandes:{max:54,min:100} },
  // Hacinamiento — umbral B (menos estricto, según Excel fila 2)
  '11_01_01_01_thm_alt': { meta:{max:0,min:15}, proximo:{max:15,min:22.5}, retos:{max:22.5,min:30}, grandes:{max:30,min:100} },
  ...
  '12_04_01_01_ipr': { meta:{max:999,min:8.2}, proximo:{max:8.2,min:0.8}, retos:{max:0.8,min:0}, grandes:{max:0,min:0} },
  '12_04_02_02_srr': { meta:{max:100,min:43.3}, proximo:{max:43.3,min:20.4}, retos:{max:20.4,min:0}, grandes:{max:0,min:0} },
  ...
  '15_02_01_04_tpd': { meta:{max:0,min:0}, proximo:{max:0,min:0.955}, retos:{max:0.955,min:1.91}, grandes:{max:1.91,min:100} },
  '15_02_01_05_tpb': { meta:{max:0,min:0}, proximo:{max:0,min:0.71}, retos:{max:0.71,min:2.1}, grandes:{max:2.1,min:100} },
  ...
  // Tasa de conflictividad social — umbrales NUEVOS del Excel
...
const INDICATOR_FILES = [
  ...
  { file: '01_04_01_04_psv.xlsx', label: 'Número de personas que viven en la calle por cada 100.000',      dir: 'desc' },
  ...
  { file: '03_03_01_05_vih.xlsx', label: 'Incidencia de VIH por 1.000.000 habitantes',                     dir: 'desc' },
  { file: '03_03_02_06_tub.xlsx', label: 'Incidencia de tuberculosis por 100.000 habitantes',               dir: 'desc' },
  { file: '03_03_03_07_mal.xlsx', label: 'Índice Parasitario Anual de Malaria',                            dir: 'desc' },
  { file: '03_03_05_08_tic.xlsx', label: 'Porcentaje de viviendas infestadas con chagas (%)',               dir: 'desc' },
  { file: '03_03_05_09_tid.xlsx', label: 'Tasa de incidencia de dengue por 10.000 habitantes',              dir: 'desc' },
  { file: '03_12_01_14_ppv.xlsx', label: 'Cobertura promedio de vacunas en menores de 1 año',              dir: 'asc'  },
  ...
  { file: '04_02_02_03_pfp.xlsx', label: 'Niños de 4 a 5 años que asisten a establecimientos preescolares', dir: 'asc' },
  { file: '05_01_01_01_pga.xlsx', label: 'Paridad de género en abandono escolar en secundaria',            dir: 'asc'  },
  { file: '05_01_01_04_pgp.xlsx', label: 'Paridad de género en la tasa global de participación (≥14 años)', dir: 'asc' },
  ...
  { file: '06_03_01_03_tar.xlsx', label: 'Índice de tratamiento de agua residual',                         dir: 'asc'  },
  ...
  { file: '08_05_02_02_tgh.xlsx', label: 'Tasa global de participación — hombres (10 años o más)',         dir: 'asc'  },
  { file: '08_05_02_03_tgm.xlsx', label: 'Tasa global de participación — mujeres (10 años o más)',         dir: 'asc'  },
  { file: '08_10_02_07_dsb.xlsx', label: 'Densidad de sucursales bancarias por 100.000 habitantes',        dir: 'asc'  },
  ...
  { file: '11_01_01_02_ssb.xlsx', label: 'Hogares sin servicio sanitario, baño o letrina (%)',             dir: 'desc' },
  { file: '11_02_01_04_atc.xlsx', label: 'Asientos disponibles en transporte colectivo (por mil hab.)',    dir: 'asc'  },
  // Tasa de hacinamiento — dos umbrales distintos, mismo archivo
  { file: '11_01_01_01_thm.xlsx', label: 'Tasa de hacinamiento (umbral A: ≤31% meta)',                    dir: 'desc', thresholdKey: '11_01_01_01_thm'     },
  { file: '11_01_01_01_thm.xlsx', label: 'Tasa de hacinamiento (umbral B: ≤15% meta)',                    dir: 'desc', thresholdKey: '11_01_01_01_thm_alt' },
  { file: '11_06_02_05_ica.xlsx', label: 'Concentración promedio de PM2.5',                               dir: 'desc' },
  { file: '11_01_01_03_ava.xlsx', label: 'Porcentaje de la población con vivienda adecuada',               dir: 'asc'  },
  ...
  { file: '15_02_01_04_tpd.xlsx', label: 'Tasa promedio de deforestación',                                dir: 'desc' },
  ...
  { file: '15_05_02_03_pbi.xlsx', label: 'Índice de pérdida de biodiversidad por incendios y minería',    dir: 'desc' },
  { file: '16_06_01_02_cep.xlsx', label: 'Porcentaje de presupuesto ejecutado',                           dir: 'asc'  },
  { file: '16_09_01_04_nic.xlsx', label: 'Niños inscritos en el registro civil (menores de 5 años)',       dir: 'asc'  },
  { file: '16_01_01_01_thp.xlsx', label: 'Tasa de homicidios por 100.000 habitantes',                     dir: 'desc' },
  ...
  { file: '04_10_01_09_pci.xlsx', label: 'Profesores calificados en nivel inicial',                        dir: 'asc'  },
]];
...
for (const ind of INDICATOR_FILES) {
  ...
  // Para indicadores con thresholdKey propio (ej: thm_alt), mapear por label
...
async function loadAvailableIndicators() {
  ...
  const ODS_NAMES = {
    ...
    '15':'ODS 15 - Ecosistemas terrestres', '16':'ODS 16 - Paz y justicia', '17':'ODS 17 - Alianzas',
  };
  const groups = {};
  for (const ind of INDICATOR_FILES) {
...
async function readExcel(filename, thresholdKey) {
  ...
  result.indicatorCode = code; // usar thresholdKey como código si existe
...
function renderAnalysisPanel(data) {
  ...
  const dirLabel = ascending ? '<span class="dir-badge dir-asc">↑ Mayor es mejor</span>' : '<span class="dir-badge dir-desc">↓ Menor es mejor</span>';
...
async function init() {
  ...
  if (selEl) selEl.addEventListener('change', e => {
    // Buscar por data-index guardado en el option para manejar duplicados (ej: thm dos umbrales)
...
function enterAtlasAndLoad() {
  ...
  setTimeout(() => {
    ...
    if (sel && INDICATOR_FILES.length > 0) {
      ...
      const tKey0 = INDICATOR_FILES[0].thresholdKey || null;
      onIndicatorChange(INDICATOR_FILES[0].file, tKey0);
    }
  }, 150);
}
