...
const ALL_THRESHOLDS = {
  ...
  '02_03_01_05_pac': { meta:{max:999,min:10}, proximo:{max:10,min:2}, retos:{max:2,min:0.001}, grandes:{max:0,min:0} },
  ...
  '05_01_01_01_pga': { meta:{max:5000,min:1}, proximo:{max:1,min:0.865}, retos:{max:0.865,min:0.73}, grandes:{max:0.73,min:0} },
  '05_01_01_02_pgm': { meta:{max:90,min:0.941}, proximo:{max:0.941,min:0.851}, retos:{max:0.851,min:0.671}, grandes:{max:0.671,min:0} },
  '05_01_01_03_pge': { meta:{max:500,min:1}, proximo:{max:1,min:0.85}, retos:{max:0.85,min:0.7}, grandes:{max:0.7,min:0} },
  '05_01_01_04_pgp': { meta:{max:5000,min:0.8}, proximo:{max:0.8,min:0.7}, retos:{max:0.7,min:0.5}, grandes:{max:0.5,min:0} },
  '05_05_01_05_acm': { meta:{max:100,min:40}, proximo:{max:40,min:30}, retos:{max:30,min:20}, grandes:{max:20,min:0} },
  '05_07_02_06_ttm': { meta:{max:5000,min:0.5}, proximo:{max:0.5,min:0.25}, retos:{max:0.25,min:0.05}, grandes:{max:0.05,min:0} },
  ...
  '07_01_01_01_cep': { meta:{max:631.4,min:171.0}, proximo:{max:171.0,min:111.0}, retos:{max:111.0,min:52}, grandes:{max:52,min:0} },
  '07_02_01_04_ecp': { meta:{max:0,min:2}, proximo:{max:2,min:3}, retos:{max:3,min:4}, grandes:{max:4,min:12} },
  ...
  '09_01_01_01_vpc': { meta:{max:5,min:2}, proximo:{max:2,min:1}, retos:{max:1,min:0.001}, grandes:{max:0,min:0} },
  ...
  '10_02_01_01_dce': { meta:{max:0,min:0.433}, proximo:{max:0.433,min:0.528}, retos:{max:0.528,min:0.622}, grandes:{max:0.622,min:1} },
  '10_02_01_03_pel': { meta:{max:90,min:0.979}, proximo:{max:0.979,min:0.772}, retos:{max:0.772,min:0.565}, grandes:{max:0.565,min:100} },
  '10_02_01_06_epd': { meta:{max:90,min:0.7}, proximo:{max:0.7,min:0.511}, retos:{max:0.511,min:0.323}, grandes:{max:0.323,min:0} },
  '10_02_01_07_mre': { meta:{max:90,min:0.96}, proximo:{max:0.96,min:0.652}, retos:{max:0.652,min:0.345}, grandes:{max:0.345,min:0} },
  '10_02_01_08_tpm': { meta:{max:90,min:0.996}, proximo:{max:0.996,min:0.775}, retos:{max:0.775,min:0.553}, grandes:{max:0.553,min:0} },
  '10_04_02_04_gin': { meta:{max:0,min:0.31}, proximo:{max:0.31,min:0.4}, retos:{max:0.4,min:0.48}, grandes:{max:0.48,min:90} },
  ...
  '12_04_01_01_ipr': { meta:{max:999,min:18.5}, proximo:{max:18.5,min:6.5}, retos:{max:6.5,min:0.01}, grandes:{max:0,min:0} },
  ...
  '16_06_01_02_cep': { meta:{max:900,min:83.4}, proximo:{max:83.4,min:71.7}, retos:{max:71.7,min:60}, grandes:{max:60,min:0} },
