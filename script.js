...
const ALL_THRESHOLDS = {
  ...
  '05_01_01_03_pge': { meta:{max:3,min:1}, proximo:{max:1,min:0.75}, retos:{max:0.75,min:0.5}, grandes:{max:0.5,min:0} },
  ...
  '10_02_01_05_gip': { meta:{max:0,min:0.31}, proximo:{max:0.31,min:0.39}, retos:{max:0.39,min:0.47}, grandes:{max:0.47,min:1} },
